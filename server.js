...
app.post('/api/seed-products', async (req, res) => {
  try {
    ...
    db.products = [
      ...
      { id: 'p7', name: 'Blush Sheen Scarf', category: 'accessories', size: 'NA', color: 'pink', occasion: 'casual', price: 599, img: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?q=80&w=1400&auto=format&fit=crop', desc: 'Lightweight scarf with soft finish and elegant drape.' }
    ];
    await writeDb(db);
